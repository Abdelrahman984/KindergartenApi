...
namespace Kindergarten.Infrastructure.Migrations
{
    ...
    [Migration("20250926062544_AddComputedAgeToStudent")]
    partial class AddComputedAgeToStudent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kindergarten.Domain.Entities.Student", b =>
                {
                    ...
                    b.Property<int>("Age")
                        ...
                        .HasColumnType("int")
                        .HasComputedColumnSql("DATEDIFF(YEAR, DateOfBirth, GETDATE()) - CASE WHEN (MONTH(DateOfBirth) > MONTH(GETDATE())) OR (MONTH(DateOfBirth) = MONTH(GETDATE()) AND DAY(DateOfBirth) > DAY(GETDATE())) THEN 1 ELSE 0 END", false);
            ...
            modelBuilder.Entity("Kindergarten.Domain.Entities.Teacher", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("aaaa5555-5555-5555-5555-555555555555"),
                            FullName = "هالة محمود",
                            IsActive = false,
                        ...
                        new
                        {
                            Id = new Guid("aaaa6666-6666-6666-6666-666666666666"),
                            FullName = "خديجة حسن",
                            IsActive = true,
                        ...
                        new
                        {
                            Id = new Guid("aaaa7777-7777-7777-7777-777777777777"),
                            FullName = "منى يوسف",
                            IsActive = true,
                        ...
                        new
                        {
                            Id = new Guid("aaaabbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            FullName = "رنا سمير",
                            IsActive = true,
            ...
            modelBuilder.Entity("Kindergarten.Domain.Entities.TeacherClassroom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            TeacherId = new Guid("aaaa1111-1111-1111-1111-111111111111"),
                            ClassroomId = new Guid("77777777-7777-7777-7777-777777777777")
                        },
                        new
                        {
                        ...
                        new
                        {
                            TeacherId = new Guid("aaaa2222-2222-2222-2222-222222222222"),
                            ClassroomId = new Guid("77777777-7777-7777-7777-777777777777")
                        },
                        new
                        {
                        ...
                        new
                        {
                            TeacherId = new Guid("aaaa3333-3333-3333-3333-333333333333"),
                            ClassroomId = new Guid("88888888-8888-8888-8888-888888888888")
                        },
                        new
                        {
